...
if (message.content === '%help') {
      ...
      .addField("**%رابط**","**يرسل لك رابط السيرفر خاص**")
.addField("**%report**","**اكتب الامر ومنشن الشخص واكتب سبب الابلاغ:يجب عمل روم باسم(بوت-السيرفر)**")
      .addField("**منشن البوت**","**اذا منشنت البوت يرد عليك**")
       .addField("**%myinv**","**يعرض عدد الانفيت حقك**")
       .addField("**%server**","**يعرض معلومات السيرفر**")
       .addField("**%id**","**يعرض معلوماتك**")
	   .addField("**%member**","**يعرص اعضاء السيرفر و حالتهم**")
	   .addField("**%image**","**يعرض صورت السيرفر**")
	   .addField("**%server invite**","**يعرض جميع انفيت السيرفر**")
	   .addField("**%botinfo**","**معلومات البوت**")
      .addField("**☢ اوامر الاداره**","** **")
.addField("**%باند**","**امر الباند من السيرفر**")
.addField("**%كيك**","**امر الطرد من السيرفر**")
       .addField("**%bc**","**برودكاست عادي**")
       .addField("**%user**","**يصنع روم يعرض اعضاء السيرفر**")
       .addField("**%قفل**","**يقفل الشات**")
       .addField("**%فتح**","**يفتح الشات**")
	   .addField("**%مسح**","**يمسح الشات**")
	   .addField("**الامر**","**معلومات الامر**")
	   .addField("**:video_game:  اوامر الالعاب**","** **")
	   .addField("**%slots**","**لعبة الحظ**")
	   .addField("**%تهكير**","**اكتب الامر ومنشن الشخص**")
	   .addField("**----------------------------------------------------**","** **")
	   .addField("** **","**رابط سيرفر الدعم الفني : https://discord.gg/DvzM29w**")
...
client.on('message', message => {
     ...
     let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)
.addField('     Help ' ,' **تم ارسال جميع الاوامر الي الخاص ✉**  ')
.setColor('#B101FC')
...
client.on('message', message => {
 ...
 if (!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply(' **❌ للأسف لا تمتلك صلاحية**');
